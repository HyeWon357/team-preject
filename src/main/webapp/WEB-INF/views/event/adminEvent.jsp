    ...
    <div id="left_list">
        ...
        <div id="main">
            ...
            <div id="contents2">
                <div id="customer">
                    <h2>
                        <strong>EVENT</strong><span>쟈뎅샵 소식을 전해드립니다.</span>
                    </h2>

                    <div class="orderDivMt">
                        <table summary="NO, 제목, 등록일, 조회수 순으로 공지사항을 조회 하실수 있습니다." class="orderTable2" border="1"
                            cellspacing="0">
                            ...
                            <tbody>
                            <c:forEach var="admin" items="${adminEList }">
                                <tr>
                                    <td class="tnone">${admin.event_id }</td>
                                    <td class="adtext">
                                    <a href="adminEventContent?event_id=${admin.event_id }">${admin.event_title }</a>
                                    </td>
                                    <td>
                                    <fmt:parseDate value="${admin.event_startDate }" var="event_startDate"  pattern="yyyy-MM-dd"/>
                                    <fmt:formatDate value="${event_startDate }" pattern="yyyy-MM-dd"/>
                                    </td>
                                    <td>
                                    <fmt:parseDate value="${admin.event_endDate }" var="event_endDate"  pattern="yyyy-MM-dd"/>
                                    <fmt:formatDate value="${event_endDate }" pattern="yyyy-MM-dd"/>
                                    </td>
                                    <td class="adtext">${admin.event_hit }</td>
                                </tr>
							</c:forEach>
                            </tbody>
                        </table>
                    ...
                    <div class="btnAreaList">
                        <div class="bwright">
                            <ul>
                                <li><a href="adminEventW" class="writeBtn">글쓰기</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="allPageMoving1">
                            ...
                            <a href="#" class="n"><img src="../images/btn/btn_pre2.gif" alt="처음으로" /></a><a href="#"
                                class="pre"><img src="../images/btn/btn_pre1.gif" alt="앞페이지로" /></a> <strong>1</strong>
                            <a href="#">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#">5</a> <a href="#"
                                class="next"><img src="../images/btn/btn_next1.gif" alt="뒤페이지로" /></a><a href="#"
                                class="n"><img src="../images/btn/btn_next2.gif" alt="마지막페이지로" /></a>
                        ...
                        <div class="searchWrap">
                            <div class="search">
                                <ul>
                                    ...
                                    <li class="web"><a href="#"><img src="../images/btn/btn_search.gif" alt="검색" /></a>
                                    </li>
                                    <li class="mobile"><a href="#"><img src="../images/btn/btn_search_m.gif"
                                                alt="검색" /></a>
                                    </li>
                                </ul>
                            </div>
