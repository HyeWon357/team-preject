...
<body>
    ...
    <div id="left_list">
		...
		<form action="eventModify" name="adminEventM" method="post">
		<input type="hidden" name="event_id" value="${adminEventM.event_id}">
		<input type="hidden" name="event_hit" value="${adminEventM.event_hit}">
            <div id="contents2">
                <div id="mypage">
                        ...
                        <table summary="분류, 제목, 상세내용, 첨부파일 순으로 궁금하신 점을 문의 하실수 있습니다." class="checkTable" border="1"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="admin" class="wlong" readonly value="${adminEventM.admin }"/></td>
                                </tr>
                               
                                <tr>
                                    <th scope="row"><span>제목</span></th>
                                    <td><input type="text" name="event_title" class="wlong" value="${adminEventM.event_title }"/></td>
                                </tr>
                                <tr>
                                    <th scope="row"><span>상세 내용</span></th>
                                    <td><textarea name="event_content" class="tta">${adminEventM.event_content }</textarea></td>
                                </tr>
                                <tr>
                                    <th scope="row"><span>시작 날짜</span></th>
                                    <td>
                                   	<input type="date" name="event_startDate" value="${adminEventM.event_startDate }"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row"><span>종료 날짜</span></th>
                                    <td>
                                   	<input type="date" name="event_endDate" value="${adminEventM.event_endDate }"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row"><span>대표 이미지</span></th>
                                    <td><input type="file" name="event_image1" class="fileType" value="${adminEventM.event_image1 }"/></td>
                                </tr>
                                <tr>
                                    <th scope="row"><span>첨부 파일</span></th>
                                    <td><input type="file" name="event_image2" class="fileType" value="${adminEventM.event_image2 }"/></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="btnArea">
                        <div class="bCenter">
                            <ul>
                                <li><a href="adminEvent" class="nbtnbig">취소</a></li>
                                <li><input type="submit" value="수정" class="sbtnMini" id="submit"></li>
                            </ul>
                        </div>
                    </div>
                    <!-- //Btn Area -->
