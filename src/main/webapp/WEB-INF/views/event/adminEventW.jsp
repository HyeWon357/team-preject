...
<body>
    ...
    <div id="left_list">
		...
		<form action="eventWrite" name="adminEventW" method="post" enctype="multipart/form-data">
            <div id="contents2">
                <div id="mypage">
                        ...
                        <table summary="분류, 제목, 상세내용, 첨부파일 순으로 궁금하신 점을 문의 하실수 있습니다." class="checkTable" border="1"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="event_title" class="wlong" /></td>
                                </tr>
                                <tr>
                                    <th scope="row"><span>상세 내용</span></th>
                                    <td><textarea name="event_content" class="tta"></textarea></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="file" name="event_image1" class="fileType" /></td>
                                </tr>
                                <tr>
                                    <th scope="row"><span>첨부 파일</span></th>
                                    <td><input type="file" name="event_image2" class="fileType" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
