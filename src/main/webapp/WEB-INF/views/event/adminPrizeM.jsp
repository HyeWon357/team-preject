...
<body>
    ...
    <div id="left_list">
		...
		<form action="prizeModify" name="adminEventM" method="post">
		<input type="hidden" name="prize_id" value="${adminPrizeM.prize_id }">
		<input type="hidden" name="prize_hit" value="${adminPrizeM.prize_hit }">
		<input type="hidden" name="prize_date" value="${adminPrizeM.prize_date }">
            <div id="contents2">
                <div id="mypage">
                        ...
                        <table summary="분류, 제목, 상세내용, 첨부파일 순으로 궁금하신 점을 문의 하실수 있습니다." class="checkTable" border="1"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="admin" class="wlong" readonly value="${adminPrizeM.admin }"/></td>
                                </tr>
                               
                                <tr>
                                    <th scope="row"><span>제목</span></th>
                                    <td><input type="text" name="prize_title" class="wlong" value="[수정]${adminPrizeM.prize_title }"/></td>
                                </tr>
                                <tr>
                                    <th scope="row"><span>상세 내용</span></th>
                                    <td><textarea name="prize_content" class="tta">${adminPrizeM.prize_content }</textarea></td>
                                </tr>
                                <tr>
                                    <th scope="row"><span>첨부 파일</span></th>
                                    <td><input type="file" name="prize_file" class="fileType" value="${adminPrizeM.prize_file }"/></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
