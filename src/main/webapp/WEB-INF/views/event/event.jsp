			...
			<div id="contents">
				<div id="mypage">
					...
					<div class="eventList">
						<ul>
							<!-- 반복 -->
							<c:forEach var="edt" items="${elist }">
							<jsp:useBean id="now" class="java.util.Date" />
							<fmt:formatDate value="${now}" pattern="yyyy-MM-dd" var="today" />
							<fmt:parseDate value="${edt.event_startDate }" var="event_startDate" pattern="yyyy-MM-dd"/>
							<fmt:formatDate value="${event_startDate }" var="start" pattern="yyyy-MM-dd" /> 
							<fmt:parseDate value="${edt.event_endDate }" var="event_endDate" pattern="yyyy-MM-dd"/>
							<fmt:formatDate value="${event_endDate }" var="end" pattern="yyyy-MM-dd" />
							<c:if test="${start<=today && today<=end}">
								<li>
									<div class="img">
										<a href="event_view?event_id=${edt.event_id }"><img src="../images/img/${edt.event_image1 }" alt="진행중 이벤트" /></a>
										</div>
										<div class="txt">
											<div class="subject"><span class="ingishbtn">진행중</span>&nbsp;${edt.event_title }</div>
