				...
				<div id="mypage">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							<div class="subject">
								<ul>
									<li>${prize_view.prize_title }</li>
								</ul>
							</div>
							<div class="data">
								<ul>
									<li>등록일<span>
									<fmt:parseDate value="${prize_view.prize_date }" var="prize_date" pattern="yyyy-MM-dd"/>
									<fmt:formatDate value="${prize_date }" pattern="yyyy-MM-dd" />
									</span></li>
									<li>조회수<span>${prize_view.prize_hit }</span></li>
								</ul>
							</div>
						</div>

						<div class="viewContents">
							${prize_view.prize_content }<br/>
							${prize_view.prize_file }
						</div>
					</div>
					...
					<div class="pnDiv web">
						<table summary="이전다음글을 선택하여 보실 수 있습니다." class="preNext" border="1" cellspacing="0">
							...
							<c:if test="${prize_next.prize_id !=null }">
								<tr>
									<th class="pre">NEXT</th>
									<td><a href="prize_view?prize_id=${prize_next.prize_id }">${prize_next.prize_title }</a></td>
								</tr>
							</c:if>
							<c:if test="${prize_prev.prize_id !=null }">
								<tr>
									<th class="next">PREV</th>
									<td><a href="prize_view?prize_id=${prize_prev.prize_id }">${prize_prev.prize_title }</a></td>
								</tr>
							</c:if>
							<c:if test="${prize_prev.prize_id ==null }">
								<tr>
					...
					<div class="btnArea btline">
						<div class="bRight">
							<ul>
								<li><a href="prize" class="sbtnMini mw">목록</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
