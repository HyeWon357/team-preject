		...
		<div id="wrap">
			...
			<div id="mainSection">
				...
				<div id="mainRoll">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<a href="#"><img src="../images/img/main_visible01.jpg"
								alt="" /></a>
						</div>
						<div class="swiper-slide">
							<a href="#"><img src="../images/img/main_visible01.jpg"
				...
				<div id="mainContents">
					...
					<!-- Best seller -->
					<div class="mtitle">
						<h2>JARDIN BEST SELLER</h2>
					</div>
					<div id="bestseller">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="img">
									<a href="#"><img src="../images/img/sample_best_seller.jpg"
										alt="Best seller 상품" /></a>
								</div>
								<div class="name">
									쟈뎅 바리스타 벨벳<br />에스프레소 원두커피
								</div>
					...
					<div class="rollbtn">
						<a class="arrowLeft" href="#"></a> <a class="arrowRight" href="#"></a>
					</div>
					<!-- //Best seller -->
					...
					<div id="mainReview">
						<ul>
							<li class="roast"><a href="#"><img
									src="../images/img/img_fresh_roast_bean.jpg"
									alt="FRESH ROAST BEAN" /></a>
								<p class="title">
									FRESH ROAST<br />BEAN
								</p></li>
							<li class="review"><a href="#"><img
									src="../images/img/img_review.jpg" alt="REVIEW" /></a></li>
							<li class="last"><a href="#">
									<p class="title">
										SPECIALTY<br />COFFEE<span>스페셜티 커피 전문점 커피 휘엘</span>
									</p>
									<div class="fiel">
										<img src="../images/img/img_coffee_fiel.jpg"
											alt="THE COFFEE CREAOR SINCE 1984" />
									</div>
							</a></li>
						</ul>
					</div>
					...
					<div id="newGoods">
						<div class="newcoffee">
							...
							<ul>
								...
								<li class="txt">종이컵 또는 작은 머그컵에 딱맞는 용량의 스틱 제품으로 다양한 커피 메뉴를
									가정과 사무실에서만날 수 있습니다.</li>
								<li class="price">5,600원</li>
							</ul>
							<div class="abimg">
								<img src="../images/img/img_newcoffee.png" alt="드립커피 로스트" />
							</div>
						</div>
						...
						<div class="mdchoice">
							<div class="one">
								...
								<ul>
									...
									<li class="txt">다크 초코렛을 연상시키는 달콤함이 입안에서 오래도록 지속되며, 풍부한
										바디감을 느낄 수 있습니다.</li>
									<li class="price">5,600원</li>
								</ul>
								<div class="img">
									<img src="../images/img/img_md_choice01.jpg" alt="MD CHOICE 상품" />
								</div>
							</div>
							...
							<div class="two">
								...
								<div class="img">
									<img src="../images/img/img_md_choice02.jpg" alt="MD CHOICE 상품" />
								</div>
							</div>
						</div>
					</div>
					...
					<div id="mainSale">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="img">
									<a href="#"><img src="../images/img/sample_sale.jpg"
										alt="sale 상품" /></a>
								</div>
								<div class="name">
									쟈뎅 바리스타 벨벳<br />에스프레소 원두커피
					...
					<div class="rollbtn">
						<a class="saleLeft" href="#"></a> <a class="saleRight" href="#"></a>
					</div>
					<!-- //sale -->
						...
						<ul>
							<li class="center">
								<div class="banner">
									...
									<p>
										원두커피의 名家<span>JARDIN BRAND</span>
									</p>
								</div>
							</li>
							<li class="left">
								<div class="img">
									<a href="#"><img src="../images/img/sample_main_brand.png"
										alt="Brand 상품" /></a>
								</div>
								<div class="name">
									쟈뎅 바리스타 벨벳<br />에스프레소 원두커피
					...
					<div id="noticeBLock">
						<ul>
							<li class="first">
								<h3>NOTICE</h3>
								<div class="img">
									<img src="../images/img/sample_notice.jpg" alt="notice image" />
								</div>
								<ul>
							...
							<li class="cln">
								...
								<div class="custCenter">
									...
									<p class="day">
										오전 9시 ~ 오후 7시<br />토/일요일 및 공휴일 제외
									</p>
									<p class="link">
										<a href="#">이용안내</a> <a href="#">FAQ</a> <a href="#">1:1문의</a>
									</p>
								</div>
							</li>
							<li class="last">
								<h3>ENJOY COFFEE</h3>
								<div class="img">
									<img src="../images/img/sample_enjoy.jpg" alt="enjoy coffee" />
								</div>
					...
					<div id="quick">
						...
						<div class="wish">
							...
							<div class="list">
								<ul>
									<li><a href="#"><img
											src="../images/img/sample_wish.gif" alt="" /></a>
									<li><a href="#"><img
											src="../images/img/sample_wish.gif" alt="" /></a>
									<li><a href="#"><img
											src="../images/img/sample_wish.gif" alt="" /></a>
							...
							<div class="total">
								<a href="#none" class="wishLeft"><img
									src="../images/btn/wish_left.gif" alt="" /></a> <span class="page">1</span>
								/ <span class="sum">3</span> <a href="#none" class="wishRight"><img
						...
						<div class="top">
							<a href="#">TOP&nbsp;&nbsp;<img
								src="../images/ico/ico_top.gif" alt="" /></a>
						</div>
					</div>
					<script type="text/javascript">
			$(function(){
				...
				<div id="footer">
					<div id="fnb">
						<ul>
							...
							<li><a href="../cus/notice_list">고객센터</a></li>
