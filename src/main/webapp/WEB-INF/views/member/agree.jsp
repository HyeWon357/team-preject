...
<script type="text/javascript">
		...
		function Check(form) {
			var total = 0;	
			var max = document.form.agree.length;

			for (var idx = 0; idx < max; idx++) {
				if (eval("document.form.agree[" + idx + "].checked") == true) {
					total += 1;
			   }
			}
			if(total==3){
				...
				<div id="member">
					...
					<div class="agreeWrap">
						...
						<p>본 약관은 2005년 5월 16일부터 시행합니다.</p>
							...
							<ul>
								<li class="chk">
									<input type="checkbox" name="agree" /><label for="agree1">이용약관에 동의합니다.</label>
								</li>
								<li class="btn">
						...
						<h4>3. 개인정보의 보유 및 이용기간</h4>
							...
							<ul>
								<li class="chk">
									<input type="checkbox" name="agree" /><label for="agree2">개인정보 보호를 위한 이용자 <span>동의사항에 동의합니다.</span></label>
								</li>
								<li class="btn">
									<a href="#" class="nbtnMini">전체보기</a>
								</li>
						...
						<h4>3. 개인정보의 보유 및 이용기간</h4>
							...
							<ul class="fn">
								<li class="chk">
									<input type="checkbox" name="agree" /><label for="agree3">개인정보 보호를 위한 이용자 <span>동의사항에 동의합니다.</span></label>
								</li>
								<li class="btn">
									<a href="#" class="nbtnMini">전체보기</a>
								</li>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>
								...
								<input type="button" value="가입하기" onClick="Check(this.form)" class="sbtnMini">
								<!--  <li><a href="javascript:agree();" class="sbtnMini">가입하기</a></li> -->
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
