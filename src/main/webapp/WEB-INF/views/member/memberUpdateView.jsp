...
function email_change(){
	...
	if(document.join.emailList.options[document.join.emailList.selectedIndex].value == '9'){
	 ...
	 console.log(document.join.d_email2.value);
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<ul class="question">
											<li>
												<input type="radio" value="yes" name="d_email_check" id="receive_yes" class="radio_t" checked="checked"/><label for="receive_yes">예</label>
											</li>
											<li>
												<input type="radio" value="no" name="d_email_check" id="receive_no" class="radio_t"/><label for="receive_no">아니오</label>
											</li>
										</ul>
									...
									<td>
										<ul class="pta">
											...
											<li class="pt5">
												<ul class="baseQues">
													<li>
														<input type="radio" value="yes" name="d_sms" id="sms_yes" class="radio_t" checked="checked"/><label for="sms_yes">예</label>
													</li>
													<li>
														<input type="radio" value="no" name="d_sms" id="sms_no" class="radio_t"/><label for="sms_no">아니오</label>
													</li>
												</ul>
											</li>
										</ul>
									...
									<td>
										<ul class="pta">
											...
											<li class="pt5">
												<ul class="baseQues">
													<li>
														<input type="radio" value="양력" name="d_sl" id="solar" class="radio_t" checked="checked"/><label for="solar">양력</label>
													</li>
													<li>
														<input type="radio" value="음력"  name="d_sl" id="lunar" class="radio_t"/><label for="lunar">음력</label>
													</li>
												</ul>
											</li>
										</ul>
